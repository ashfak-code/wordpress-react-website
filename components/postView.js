...
class PostView extends Component {
  ...
  render() {
      let ad_check=this.state.acf.["banner-ads"]
      let newContent = this.state.renderContent;

     if(typeof ad_check !== "undefined")
        {
      ...
      newContent = wipcontent.replace(/<\/figure>/gi, below_image);
        } 
